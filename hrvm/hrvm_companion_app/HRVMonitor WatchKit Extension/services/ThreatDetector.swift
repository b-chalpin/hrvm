// ======================================================================
// \title  ThreatDetector.swift
// \author bchalpin/ Nick Adams on 3/15/22.
// \brief  ThreatDetector is a singleton class that encapsulates the functionality to detect and acknowledge
...
//         acknowledge threats (acknowledgeThreat), generate labels for LR, and switch between prediction modes (checkThreatMode).
//
