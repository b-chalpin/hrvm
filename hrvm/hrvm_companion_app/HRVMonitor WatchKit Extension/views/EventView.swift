...
struct EventView_Previews: PreviewProvider {
    static let dummyHrv = HrvItem(value: 0.0, timestamp: Date(), deltaHrvValue: 0.0, deltaUnixTimestamp: 0.0, avgHeartRateMS: 0.0, numHeartRateSamples: 0, hrSamples: [], meanRR: 0.0, medianRR: 0.0)
